...
//            }
    ...
    void getCityPath() {
        ...
        cityConnectionList.add(new CityConnection("ქობულეთი", "ფოთი", 46, 44100));
        cityConnectionList.add(new CityConnection("ქობულეთი", "ოზურგეთი", 32, 26400));
        ...
        cityConnectionList.add(new CityConnection("სამტრედია", "ჩოხატაური", 26, 28200));
        ...
        cityConnectionList.add(new CityConnection("ჩოხატაური", "ოზურგეთი", 28, 29000));
        cityConnectionList.add(new CityConnection("ჩოხატაური", "ლანჩხუთი", 40, 36100));
        ...
        cityConnectionList.add(new CityConnection("ზარზმა", "აბასთუმანი", 33, 23600));
        cityConnectionList.add(new CityConnection("ზარზმა", "ხულო", 88, 48500));
        cityConnectionList.add(new CityConnection("ხულო", "შუახევი", 15, 16800));
        cityConnectionList.add(new CityConnection("შუახევი", "ქედა", 35, 28600));
        cityConnectionList.add(new CityConnection("ქედა", "ბათუმი", 39, 38300));
        ...
        cityConnectionList.add(new CityConnection("ფოთი", "ქობულეთი", 46, 44100));
        cityConnectionList.add(new CityConnection("ოზურგეთი", "ქობულეთი", 32, 26400));
        ...
        cityConnectionList.add(new CityConnection("ჩოხატაური", "სამტრედია", 26, 28200));
        ...
        cityConnectionList.add(new CityConnection("ოზურგეთი", "ჩოხატაური", 28, 29000));
        cityConnectionList.add(new CityConnection("ლანჩხუთი", "ჩოხატაური", 40, 36100));
        ...
        cityConnectionList.add(new CityConnection("აბასთუმანი", "ზარზმა", 33, 23600));
        cityConnectionList.add(new CityConnection("ხულო", "ზარზმა", 88, 48500));
        cityConnectionList.add(new CityConnection("შუახევი", "ხულო", 15, 16800));
        cityConnectionList.add(new CityConnection("ქედა", "შუახევი", 35, 28600));
        cityConnectionList.add(new CityConnection("ბათუმი", "ქედა", 39, 38300));
        ...
        CityObj startCity = new CityObj("რუსთავი", "რუსთავი", 0, 0);
        CityObj finishCity = new CityObj("ბათუმი", "", 0, 0);
